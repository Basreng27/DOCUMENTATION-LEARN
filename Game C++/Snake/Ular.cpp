...
#include <windows.h>
#define batas_atas 2
#define batas_bawah 25
#define batas_samping 2
#define batas_samping_k 80
using namespace std;
...
bool isDestroy(){
	if(iX == batas_samping_k){ 
		iX = 3; gotoxy(78, iY); cout << " "; 
	}
	
	if(iX == batas_samping){
		iX = 77; gotoxy(2, iY); cout << " "; 
	}
	
	if(iY == batas_atas){
		iY = 22; gotoxy(iX, 2); cout << " "; 
	}
	
	if(iY == batas_bawah){ 
		iY = 3; gotoxy(iX, 23); cout << " "; 
	}
